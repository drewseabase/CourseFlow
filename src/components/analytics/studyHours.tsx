    ...
    <div className={`${panel} p-7`}>
      ...
      <div className="flex items-end gap-3 h-70 py-5">
        {currentData.map((item, index) => {
          const height = getBarHeight(item.hours);
          ...
          return (
            ...
            >
              {/* Value Label (on top) */}
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[12px] font-bold text-[#18181B]">
                {item.hours}h
              </div>
